  ...
  if (loading) {
    return (
      <div className="flex min-h-[80vh] items-center justify-center">
        <div className="cosmic-gradient-text text-xl">Loading profile data...</div>
      </div>
    )
  }
    ...
    <div className="container py-12 md:py-16">
      <div className="mb-8 flex justify-between items-center">
        <h1 className="text-3xl font-bold tracking-tight">
          ...
          <span className="cosmic-gradient-text">Profile</span>
        </h1>

        {!isEditing && (
          <Button 
            onClick={() => setIsEditing(true)} 
            className="bg-cosmic-blue/20 text-cosmic-blue hover:bg-cosmic-blue/30"
          >
      ...
      <div className="grid gap-8 md:grid-cols-12">
        ...
        <Card className="col-span-12 md:col-span-4 border-cosmic-blue/20 bg-cosmic-darker/80 backdrop-blur-sm">
          {!isEditing ? (
            <>
              <CardHeader className="relative pb-8">
                <div className="absolute inset-0 h-32 bg-gradient-to-r from-cosmic-blue to-cosmic-purple opacity-30 rounded-t-lg"></div>
              ...
              <CardFooter className="flex justify-center gap-4 pt-2 pb-6">
                {user.github_id && (
                  <Button 
                    variant="outline" 
                    size="icon"
                    className="rounded-full border-cosmic-blue/30 hover:bg-cosmic-blue/10"
                    asChild
                  >
        ...
        <div className="col-span-12 md:col-span-8 space-y-8">
          <Card className="border-cosmic-blue/20 bg-cosmic-darker/80 backdrop-blur-sm">
            {!isEditing ? (
              <>
                <CardHeader>
                ...
                <CardContent className="space-y-6">
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <div className="flex h-10 items-center rounded-md border border-cosmic-blue/20 bg-cosmic-dark/50 px-3 py-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="min-h-[100px] rounded-md border border-cosmic-blue/20 bg-cosmic-dark/50 px-3 py-2">
          ...
          {/* {!isEditing && (
            <Card className="border-cosmic-blue/20 bg-cosmic-darker/80 backdrop-blur-sm">
              <CardHeader>
                ...
                <CardDescription>Your recent interview activities</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="rounded-md border border-cosmic-blue/20 bg-cosmic-dark/50 p-6 text-center">
                  {user.activity ? (
                    <pre className="whitespace-pre-wrap text-left text-sm text-gray-300">
                      {user.activity}
                    </pre>
                  ) : (
