  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background p-4 md:p-6">
      <div className="w-full max-w-md">
        <Card className="border border-zinc-800 bg-card/95 shadow-lg backdrop-blur-sm">
          ...
          <CardContent>
            <Tabs defaultValue="signin" value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="signin">
                <form className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        required
                        className="pl-9 border border-zinc-800"
                      />
                    </div>
                  </div>
                  <div className="space-y-2">
                  ...
                  <Button formAction={signin} className="w-full" type="submit">
                    Sign In
                  </Button>
                </form>
              </TabsContent>
              ...
              <TabsContent value="signup">
                <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); handleSignup(new FormData(e.currentTarget)); }}>
                  <div className="space-y-2">
                  ...
                  <Button formAction={handleSignup} className="w-full" type="submit" disabled={isSigningUp}>
            ...
            <div className="grid gap-3">
              <Button 
                ...
                className="bg-white hover:bg-white/90 text-black border border-zinc-800 transition-colors"
              >
              ...
              <Button 
                ...
                className="bg-black hover:bg-black/90 border border-zinc-800 transition-colors"
              >
